...
class aligner_md_coverage extends uvm_subscriber #(md_seq_item);
    ...
    `uvm_component_utils(aligner_md_coverage)
    ...
    local md_seq_item  trans_rx;
    local md_seq_item  trans_tx;
    local logic [2:0]  last_rx_size;
    ...
    covergroup rx_cg;
        ...
        // Este cross une el resultado del DUT con el par (size, offset)
    ...
    covergroup tx_cg;
        ...
        // Tamano de la transferencia TX (segun la config de CTRL)
        ...
        // Offset de la transferencia TX (segun la config de CTRL)
    ...
    function new(string name, uvm_component parent);
        ...
        trans_rx     = md_seq_item::type_id::create("cov_rx_dummy");
        trans_tx     = md_seq_item::type_id::create("cov_tx_dummy");
        last_rx_size = 3'h1;
        rx_cg        = new();
        tx_cg        = new();
    endfunction
