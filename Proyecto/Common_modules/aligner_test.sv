    ...
    task run_phase(uvm_phase phase);
        ...
        begin
            ...
            for (int b = 0; b <= int'(n_reconfig); b++) begin
                ...
                // (fifos con datos, drops acumulados, interrupciones activas)
                if (b < int'(n_reconfig)) begin
                    ...
                    // (estas lecturas extra ademas suman cobertura de STATUS)
                    begin
			     ...
			     // Nota: los bits [19:16 son los bits del nivel de
                             ...
                             // verificar que la fifo de recepcion este vacion,
                             // que son los bits 11:8 del registro de estadp
