...
package aligner_apb_registerfile_model;
    ...
    class aligner__STATUS extends uvm_reg;
        ...
        virtual function void build();
            ...
            this.RX_LVL.configure(this, 3, 9, "RO", 1, 'h0, 1, 1, 0);
            this.reserved1 = new("reserved1");
    ...
    class aligner__IRQEN extends uvm_reg;
        ...
        virtual function void build();
            ...
            this.RX_FIFO_EMPTY.configure(this, 1, 0, "W1C", 0, 'h1, 1, 1, 0);
            this.RX_FIFO_FULL = new("RX_FIFO_FULL");
            this.RX_FIFO_FULL.configure(this, 1, 1, "W1C", 0, 'h1, 1, 1, 0);
            this.TX_FIFO_EMPTY = new("TX_FIFO_EMPTY");
            this.TX_FIFO_EMPTY.configure(this, 1, 2, "W1C", 0, 'h1, 1, 1, 0);
            this.TX_FIFO_FULL = new("TX_FIFO_FULL");
            this.TX_FIFO_FULL.configure(this, 1, 3, "W1C", 0, 'h1, 1, 1, 0);
            this.MAX_DROP = new("MAX_DROP");
            this.MAX_DROP.configure(this, 1, 4, "W1C", 0, 'h1, 1, 1, 0);
